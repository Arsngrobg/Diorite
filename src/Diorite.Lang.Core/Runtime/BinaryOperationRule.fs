...
//
// ------------------------------------------------------------------------------------------------------------------
// File:    BinaryOperationRule.fs
// Summary: The type definition for the BinaryOperationRule, which defines the behaviour for a specific binary
//          operation on a pair of ValueTypes
// Author:  Arsngrobg
// Version: v1.1
// ------------------------------------------------------------------------------------------------------------------
