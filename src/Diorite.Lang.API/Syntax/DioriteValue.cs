...
//
// ------------------------------------------------------------------------------------------------------------------
// File:    DioriteValue.cs
// Summary: The definition for the DioriteValue, which is the fundamental (atomic) value in Diorite - it maps to the
//          ValueType in the core layer
// Author:  Arsngrobg
// Version: v1.0
// ------------------------------------------------------------------------------------------------------------------
...
/// </summary>
public abstract class DioriteValue : IDioriteView<Core.Syntax.ValueType>
{
    /// <summary>
    ...
    ///     </p>
    /// </summary>
    public static readonly DioriteValue Undefined = new UndefinedValue();

    /// <summary>
    ///     <p>A constant value for the <c>Number</c> core type.</p>
    ///     <p>It is a <c>Number</c> carrying a value of <c>double.PositiveInfinity</c>.</p>
    /// </summary>
    public static readonly DioriteValue PInfinity = new NumberValue(double.PositiveInfinity);
    /// <summary>
    ///     <p>A constant value for the <c>Number</c> core type.</p>
    ///     <p>It is a <c>Number</c> carrying a value of <c>double.NegativeInfinity</c>.</p>
    /// </summary>
    public static readonly DioriteValue NInfinity = new NumberValue(double.NegativeInfinity);
    ...
    /// </summary>
    public static readonly DioriteValue ImUnit    = new ComplexValue(0, 1);
    ...
    public static DioriteValue OfNumber(double value)
    {
    ...
    public static DioriteValue OfComplex(double real, double imaginary) =>
    ...
    private sealed class NumberValue : DioriteValue
    {
    ...
    private sealed class ComplexValue : DioriteValue
    {
    ...
    private sealed class UndefinedValue : DioriteValue
    {
        public override Core.Syntax.ValueType AsCoreType() =>
